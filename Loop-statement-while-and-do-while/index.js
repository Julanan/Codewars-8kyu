...
//given: 2 parameters of str and integers
//output: write a loop statement within the function that loops n times
//Each time through the loop it will add one * to str, 
//first time will add a * to the left side of str, the second time will add a * to the right side.
